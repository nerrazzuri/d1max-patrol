...
```
Expected: **1767**（基线 1613 + 本卷 154：Task 1 的 14、Task 2 的 9、Task 3 的 12、Task 4 的 19、Task 5 的 17、Task 6 的 19、Task 7 的 23（test_export.py 22 + test_retention_sweep.py 追加 1）、Task 8 的 41 —— 对不上就去看是哪个任务的参数化条数跟计划里写的不一样，**不要改计划去迁就实际**，先查清楚少的是哪一条）。
