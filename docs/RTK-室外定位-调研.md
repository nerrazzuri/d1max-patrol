...
> **决定(用户 2026-09-26,W08 §4 第 6 项)**:**自建基站**——采购 UM982 模块 + 天线架在庄园里,改正数据经站点主机、
> 庄园 WiFi(2.4/5 GHz)发给狗,4G/5G 备用。下面第 2 节的三种网络改正源不再是主路;狗这头仍要自己写
> 「改正数据 → LK1220D 串口」的桥(厂商驱动只认六分 SDK)。见 `docs/W08-导航架构决策记录.md` 决定 4。
